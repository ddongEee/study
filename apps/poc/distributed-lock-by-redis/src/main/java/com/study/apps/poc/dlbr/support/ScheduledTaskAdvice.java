...
public class ScheduledTaskAdvice {
    ...
    @Around("@annotation(com.study.apps.poc.dlbr.support.ScheduledTaskAdvice.SynchronousScheduled)")
    public Object proceed(final ProceedingJoinPoint joinPoint) throws Throwable {
        RedisCommands<String, String> sync = statefulRedisConnection.sync();
        final SynchronousScheduled annotation = ((MethodSignature) joinPoint.getSignature()).getMethod().getAnnotation(ScheduledTaskAdvice.SynchronousScheduled.class);
